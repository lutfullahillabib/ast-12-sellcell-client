...
const Blog = () => {
    return (
        ...
        <section className="text-white bg-info">
            <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8 shadow-xl">
                ...
                <div className="divide-y text-justify">
                    ...
                    {/* Q-1 */}
                    <div className="py-6 space-y-2  gap-5 grid  md:grid-cols-12 md:gap-8 md:space-y-0">
                    ...
                    <div className="py-6 space-y-2  gap-5 grid  md:grid-cols-12 md:gap-8 md:space-y-0">
                        ...
                        <p className="md:pl-0 md:col-span-7">
                            ...
                            <a className='underline p-1 flex justify-center items-center text-2xl hover:text-black duration-1000 text-primary font-semibold'
                    ...
                    <div className="py-6 space-y-2  gap-5 grid  md:grid-cols-12 md:gap-8 md:space-y-0">
                        ...
                        <div className="md:pl-0 md:col-span-7">
                            ...
                            <ul className='list-disc'>
                                ...
                                <li>
                                    In the <a className='underline p-1 text-2xl hover:text-black duration-1000 text-primary font-semibold'
                                        target="_blank" rel="noopener noreferrer"
